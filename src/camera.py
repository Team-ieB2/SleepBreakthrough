...
class Camera():
    def __init__(self):
        ...
        self.face_cascade_path = os.path.abspath("src/learningdata/haarcascade_frontalface_alt.xml")
        self.eye_cascade_path = os.path.abspath("src/learningdata/haarcascade_eye_tree_eyeglasses.xml")
        self.gray = None
        self.face_area = []
    ...
    def calc_face_avg(self, face_area):
